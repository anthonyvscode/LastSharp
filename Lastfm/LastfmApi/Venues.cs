...
namespace Lastfm
{
    public partial class LastfmApi
    {
        ...
        public LastfmResponse<VenueList> venueSearch(string venue)
        {
        ...
        /// <returns>List of venues</returns>
        public LastfmResponse<VenueList> venueSearch(string venue, string country)
        {
        ...
        /// <returns>List of venues</returns>
        public LastfmResponse<VenueList> venueSearch(string venue, string country, int? page, int? limit)
        {
            ...
            return Execute<LastfmResponse<VenueList>>(request).Data;
        }
        #endregion
        ...
        public LastfmResponse<EventsList> venueGetEvents(string venueId)
        {
            var request = new RestRequest(Method.GET);
        ...
        public LastfmResponse<EventsList> venueGetPastEvents(string venueId)
        {
        ...
        /// <param name="venueId">The Last.fm Id for the venue you would like to fetch event listings for.</param>
        /// <returns>paginated list of all the events held at this venue in the past.</returns>
        public LastfmResponse<EventsList> venueGetPastEvents(string venueId, int? page, int? limit)
        {
            var request = new RestRequest(Method.GET);
